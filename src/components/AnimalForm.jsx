...
export default function AnimalForm({
  ...
  function handleChange(e) {
    ...
    // 🔥 MEJORA: Límite de caracteres para Name (máx 20)
    ...
    >
      ...
      <div className="grid gap-1.5">
        ...
        <p className="text-xs text-gray-500 dark:text-gray-400">
          {values.name.length}/20 characters
        </p>
      ...
      <div className="grid gap-1.5">
        ...
        {errors.type && (
          <p id="error-type" className="text-xs text-red-600" role="alert">
            {errors.type}
          </p>
        )}
      </div>
      ...
      <div className="grid gap-1.5">
        ...
        />
        {errors.age && (
          <p id="error-age" className="text-xs text-red-600" role="alert">
            {errors.age}
          </p>
        )}
      </div>
      ...
      <div className="grid gap-1.5">
        ...
        />
        {errors.weight && (
          <p id="error-weight" className="text-xs text-red-600" role="alert">
            {errors.weight}
          </p>
        )}
      </div>
      ...
      <div className="grid gap-1.5">
        ...
        {errors.status && (
          <p id="error-status" className="text-xs text-red-600" role="alert">
            {errors.status}
          </p>
        )}
      </div>
      ...
      <div className="flex items-center justify-end gap-3 pt-2">
        <button
          ...
          dark:border-neutral-700 dark:text-gray-200 dark:hover:bg-neutral-800"
          disabled={submitting}
        >
          Reset
        </button>

        {/* 🔥 MEJORA 2 — BOTÓN DINÁMICO "Saving…" */}
        <button
          type="submit"
          disabled={submitting}
